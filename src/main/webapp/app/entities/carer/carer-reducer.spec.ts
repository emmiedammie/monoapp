...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './carer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARER actions', async () => {
      const expectedActions = [
        {
