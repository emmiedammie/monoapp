...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rota.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROTA actions', async () => {
      const expectedActions = [
        {
